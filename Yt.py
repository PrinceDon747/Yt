...
time.sleep(6)
os.system(f'xdg-open https://github.com/KRISHHack99')
print("")
print("")
...
princp=[]
url = 'https://raw.githubusercontent.com/KRISH2nd/XLM/main/prox.txt'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/KRISH2nd/XLM/blob/main/bbnew.txt').text
        ua=open('bbnew.txt','w')
